            ...
            <section className="relative h-[60vh] flex items-center justify-center text-center text-white">
                ...
                <div className="relative z-10 container mx-auto px-4">
                    ...
                    <Button asChild size="lg" className="bg-gold hover:bg-gold-dark text-navy font-bold text-lg px-8 py-6 rounded-full shadow-lg">
                        <Link href="/admissions">Apply for Admission 2025-26</Link>
                    </Button>
                </div>
            </section>
                ...
                <div className="max-w-3xl mx-auto">
                    <Accordion type="single" collapsible className="w-full space-y-4">
                        {[
                            ...
                            { q: "What is the admission process for 2025-26?", a: "Admissions are simple and transparent. You can fill out the enquiry form online or visit our campus. Selection is based on merit and interaction for higher grades." },
            ...
            <section className="py-20 bg-grain text-center">
                <div className="container mx-auto px-6">
                    ...
                    <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
                        Admissions are open for the 2025-26 academic session. Give your child the advantage of a world-class education.
                    </p>
