...
import { Loader2, RefreshCw, Mail, Phone, ArrowLeft, Send } from "lucide-react";
                ...
                <div className="flex items-center gap-4">
                    <Link href="/admin-school-portal/dashboard">
                        <Button
                            variant="outline"
                            size="icon"
                            className="h-10 w-10 rounded-full bg-gold text-navy border-gold/60 shadow-sm hover:bg-gold-dark"
                        >
                    ...
                    <div>
                        <h2 className="text-3xl font-display font-bold text-navy flex items-center gap-2">
                            <Send className="w-8 h-8 text-blue-600" /> Enquiries
                        </h2>
                        <p className="text-muted-foreground mt-1">Review student enquiries and questions submitted by parents.</p>
                    </div>
                </div>
                <Button
                    onClick={fetchData}
                    ...
                    size="sm"
                    disabled={loading}
                    className="bg-gold text-navy border-gold/60 font-bold hover:bg-gold-dark disabled:bg-gold/70 disabled:text-navy/70"
                >
                                            ...
                                            <Dialog>
                                                <DialogTrigger asChild>
                                                    <Button
                                                        variant="outline"
                                                        size="sm"
                                                        className="bg-gold text-navy border-gold/60 font-bold hover:bg-gold-dark"
                                                    >
                                                        View Full
                                                    </Button>
                                                </DialogTrigger>
