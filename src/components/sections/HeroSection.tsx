...
export default function HeroSection({ data, stats }: { data: any, stats?: any[] }) {
    ...
    return (
        <section className="relative w-full bg-royal-blue py-0">
            <div className="w-full px-0">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-1 min-h-[85vh]">
                    ...
                    <div className="lg:col-span-8 relative shadow-2xl group bg-royal-blue-dark">
                        ...
                        <div className="relative z-10 h-full flex flex-col justify-center p-8 md:p-12 lg:p-16 text-white max-w-3xl">
                            ...
                            <motion.h1
                                ...
                                className="font-display text-5xl md:text-7xl font-bold leading-tight drop-shadow-xl"
                            ...
                            >
                                <a href={data.cta1Href} className="bg-gold text-royal-blue-dark font-bold px-8 py-3.5 rounded-full shadow-lg hover:bg-white hover:text-royal-blue-dark transition-all transform hover:-translate-y-1">
                                    Enquire Now
                                </a>
                                <a href={data.cta2Href} className="flex items-center gap-3 text-white font-medium hover:text-gold transition-colors px-4 py-3 group">
                                    <span className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center backdrop-blur-md border border-white/20 group-hover:bg-gold grp-hover:border-gold transition-all duration-300">
                                        <Play className="w-5 h-5 fill-white group-hover:fill-royal-blue-dark transition-colors" />
                                    </span>
                                    Watch Video
                                </a>
                            </motion.div>
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-1">
                        ...
                        {/* Top Right - Students */}
                        <div className="relative h-[45%] overflow-hidden shadow-xl group bg-royal-blue-dark">
                            <Image
                        ...
                        <div className="relative h-[55%] overflow-hidden shadow-xl group bg-royal-blue-dark">
                            <Image
                ...
                {/* Stats Bar */}
                <div className="relative z-20 -mt-16 mx-auto w-[95%] bg-white/95 backdrop-blur rounded-3xl shadow-2xl p-6 md:p-8 grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-gray-100 border border-gray-100">
                    {displayStats.map((stat: any, idx: number) => (
                        <div key={idx} className={`text-center ${idx > 0 ? "pl-8" : ""}`}>
                            ...
                            <p className="text-royal-blue-dark font-medium uppercase tracking-wider text-xs md:text-sm">{stat.label}</p>
                        </div>
                    ))}
                </div>
            </div>
