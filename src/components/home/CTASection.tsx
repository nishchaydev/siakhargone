...
export function CTASection() {
    return (
        <section className="py-24 md:py-32 relative overflow-hidden bg-royal-blue">
            ...
            <div className="container mx-auto max-w-5xl px-4 relative z-10 text-center">
                ...
                >
                    <Button asChild size="lg" className="w-full sm:w-auto bg-gold hover:bg-gold-light text-royal-blue-dark font-bold text-lg px-8 py-6 rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all">
                        <Link href="/admissions">
                            Apply Now
                        </Link>
                    </Button>

                    <Button asChild size="lg" className="w-full sm:w-auto border-white text-white hover:bg-white hover:text-royal-blue font-semibold text-lg px-8 py-6 rounded-full transition-all">
                        <Link href="/contact">
